...
package object boincrpc:
  ...
  final case class CoProcessor(name: String, memory: Double, flops: Double, openCL: Option[CoProcessorOpenCL])
  ...
  final case class CCStatus(networkStatus: Int, taskMode: Int, gpuMode: Int, networkMode: Int)
  ...
  final case class FileRef(fileName: String, openName: Option[String], mainProgram: Boolean, copyFile: Boolean)
  ...
  final case class BoincProjectMetaData(name: String,
                                        url: String,
                                        general_area: String,
